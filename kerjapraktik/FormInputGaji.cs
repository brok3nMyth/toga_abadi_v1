    ...
    public partial class FormInputGaji : Form
    {
        ...
        private void buttonKunciGaji_Click(object sender, EventArgs e)
        {
            ...
            if (textBoxNama.Enabled == true)
            {
                try
                {
                    if (textBoxNama.Text !=""&& textBoxTempat.Text!="")
                    {
                    ...
                    {
                        MessageBox.Show("Nama pegawai & cabang tidak boleh kosong", "ALERT!");
                    }
        ...
        private void buttonCari_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Kode Artikel tidak boleh kosong", "ALERT!");
            }
        ...
        {
            if (textBoxArt.Text!="" && textBoxJumlah.Text !="" && comboBoxBagian.Text!="")
            {
                //kasbon 
            ...
            {
                MessageBox.Show("Kode Artikel, bagian, jumlah tidak boleh kosong", "ALERT!");
            }
        }
        ...
        private void buttonTambah_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Mohon menekan button check terlebih dahulu","ALERT!");
                }
