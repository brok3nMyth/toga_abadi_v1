...
namespace ProjectUTS
{
    public partial class FormDeleteSupplier : Form
    {
        ...
        private void pictureBoxOk_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult konfirmasi = MessageBox.Show("The selected supplier will be deleted. Are you sure?",
                ...
                if (konfirmasi == System.Windows.Forms.DialogResult.Yes)
                {
                    try
                    {
                        Supplier s = new Supplier(textBoxKode.Text, textBoxNama.Text, textBoxTelephone.Text);

                        Supplier.HapusData(s);

                        MessageBox.Show("Selected supplier has been deleted", "Info");
                    ...
                    {
                        MessageBox.Show("Failed to delete supplier. Error Message : " + exc.Message, "Error");
                    }
                }
            }
        }
